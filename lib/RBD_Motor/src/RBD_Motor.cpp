...
namespace RBD
{
  ...
  void Motor::on(bool _stop_everything)
  { // default: true
    // setSpeed(255, _stop_everything);
    _motorEnabled = true;
  }

  void Motor::off(bool _stop_everything)
  { // default: true
  ...
  void Motor::setSpeed(int value, bool _stop_everything)
  { // default: true
  ...
  void Motor::setSpeedPercent(int value, bool _stop_everything)
  { // default: true
  ...
  void Motor::stopMotor(int value, unsigned long timeout)
  {
    _stopEverything();
